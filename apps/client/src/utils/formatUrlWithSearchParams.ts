 ...
 * {@link URLSearchParams} accepts, such as a string, object, etc.
 *
 * @remarks
 *
 * If URL already has search parameters, those will be merged with the
 * provided arguments in order. Note that they will *NOT* be overwritten as
...
export const formatUrlWithSearchParams = (
  ...
  // URL's `searchParams` are merged with the `searchParams` in order
